...
"x86_64\-linux-6\.12\.16\-gentoo\-dist" or
	die "Errno architecture (x86_64\-linux-6\.12\.16\-gentoo\-dist) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
