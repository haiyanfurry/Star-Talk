...
tie %Config, 'Config', {
    archlibexp => '/usr/lib64/perl5/5.42/x86_64-linux',
    ...
    osname => 'linux',
    osvers => '6.12.16-gentoo-dist',
    path_sep => ':',
    privlibexp => '/usr/lib64/perl5/5.42',
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/local/lib64/perl5/5.42/x86_64-linux',
    sitelibexp => '/usr/local/lib64/perl5/5.42',
    so => 'so',
    useithreads => undef,
